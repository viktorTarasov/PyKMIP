...
from kmip.core.enums import AttributeType, CryptographicUsageMask, LinkType
...
class TestCryptographicObject(TestCase):
    ...
    def test_get_attribute_list(self):
        ...
        self.assertIn(AttributeType.CRYPTOGRAPHIC_USAGE_MASK.value,
            attributes)
    ...
    def test_validate_another_link_of_same_type(self):
        ...
        self.assertRaises(exceptions.InvalidField, dummy.validate_link, link_bis)
