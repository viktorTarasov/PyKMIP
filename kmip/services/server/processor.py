...
from kmip.core.messages.payloads.discover_versions import DiscoverVersionsResponsePayload
...
#        time_stamp = header.time_stamp
    ...
    def _process_discover_versions_request(self, payload):
        ...
        result = self._handler.discover_versions(protocol_versions=protocol_versions)
        ...
        resp_pl = DiscoverVersionsResponsePayload(protocol_versions=result_protocol_versions)
